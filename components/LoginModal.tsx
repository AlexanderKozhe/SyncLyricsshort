...
const ADMIN_PASSWORD = "AlexK2008@";
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6 space-y-4">
            <label htmlFor="password-input" className="block mb-2 text-sm font-medium text-slate-300">Пароль</label>
            <input
              ...
              className="bg-slate-900 border border-slate-700 text-slate-200 text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 block w-full p-2.5"
              required
            />
